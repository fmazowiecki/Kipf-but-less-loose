...
\paragraph{Turing complete MPNNs.}
 ...
 \floris{This is a bit loosely interpreted. I just meant that if you give me a TM which computes on input labeled graph a function f assigning labels to the vertices, then we can obtain f(G) by means of an MPNN. It is not TM completeness as I would normally mean. Perhaps Loukas clarifies this a bit more?}
