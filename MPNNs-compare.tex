...
\filip{No way. I agree that for $\sqsubseteq$ it is confusing to have a stronger thing on the left, but we cannot use the same notation with two meanings (for labellings we have the same notation but with the opposite meaning for weaker)}
...
\paragraph{Remarks.} The previous definitions all assume the input labelled graph to be fixed. One could consider an alternative definition where the distinguishing power is compared with regards to all
